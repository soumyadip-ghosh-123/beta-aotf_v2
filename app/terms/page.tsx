...
export default function Page() {
  return (
    <div>
      ...
      <div className="py-8 md:py-16 lg:py-20 bg-linear-to-b from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 min-h-screen">
        <div className="container mx-auto px-4 md:px-8 pb-10">
          <Card className="shadow-lg rounded-2xl">
            <CardHeader className="pb-6 border-b">
              <p className="text-xl font-bold tracking-tight mb-0">
                Terms & Conditions
              </p>
            ...
            <CardBody className="prose prose-gray dark:prose-invert max-w-none space-y-8 pt-6">
              {/* INTRODUCTION */}
              <section>
                ...
                <p>
                  ...
                  including tuition assignments, project-based freelance work,
                  or skill-based services.
                </p>
              </section>
              ...
              <section>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <strong> Candidates/Job-seekers</strong> for project-based
                    or skill-based services.
                  </li>
                </ul>
                ...
                <p className="mt-4">
                  ...
                  facilitation and is not liable for continuation, termination,
                  or the quality of services delivered between the parties.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  <strong>25%</strong> is released to the Teacher by the
                  Academy.
                </p>
                ...
                <ul>
                  <li>
                    The Academy charges a{" "}
                    <strong>25% service commission</strong> on each freelance
                    project and Job.
                  </li>
                  <li>
                    The commission percentage will be clearly communicated
                    before assigning a project.
                  </li>
                  <li>
                    Direct payment between Client and Candidates/Job-seekers
                    without Academy authorization is strictly prohibited for the
                    first project.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul>
                  ...
                  <li>
                    No Teacher or Freelancer shall accept direct payment from
                    any Client for the first month/project unless approved by
                    the Academy.
                  </li>
                  <li>
                    Any unauthorized transaction may lead to suspension or
                    removal from the Academy’s network.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul>
                  <li>
                    ...
                    Teacher shall receive <strong>50%</strong> of the first
                    month’s remuneration if valid proof is provided.
                  </li>
                  <li>
                ...
                <ul>
                  ...
                  <li>
                    If discontinuation is due to Candidates/Job-seekers issues
                    (poor communication, delay, misconduct), no payment will be
                    guaranteed.
                  </li>
                </ul>
                ...
                <p className="mt-4">
                  ...
                  in all refund and dispute matters.
                </p>
              </section>
              ...
              <section>
                ...
                <ul>
                  <li>
                    Maintain professionalism, punctuality, and respectful
                    behavior.
                  </li>
                  <li>
                    Ensure clear communication with Clients and the Academy.
                  </li>
                  <li>
                    Avoid negligence, misconduct, or unprofessional actions.
                  </li>
                  <li>
                ...
                <h3 className="font-bold text-xl mt-6">
                  For Clients/Guardians
                </h3>
                <ul>
                  <li>Provide accurate requirements and expectations.</li>
                  <li>
                    Behave respectfully with Teachers, Candidates/Job-seekers,
                    and Academy staff.
                  </li>
              ...
              <section>
                ...
                <ul>
                  ...
                  <li>
                    The Academy is not responsible for disputes between Clients
                    and Teachers/Candidates/Job-seekers.
                  </li>
                  <li>
              ...
              <section>
                ...
                <p>
                  Either party may terminate the relationship by providing
                  written notice. All pending dues or refunds will be settled as
                  per the applicable policies.
                </p>
              </section>
