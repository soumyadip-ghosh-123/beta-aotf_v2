    ...
    <main className="mx-auto max-w-7xl px-6 py-16">
      ...
      <section className="mb-16 text-center">
        ...
        <p className="mx-auto mt-4 max-w-3xl text-lg text-gray-600">
          Academy of Tutorials & Freelancers (AOTF) is a dual-service marketplace
          that connects guardians with trusted teachers and clients with skilled
          professionals through a transparent and structured platform.
        </p>
      </section>
