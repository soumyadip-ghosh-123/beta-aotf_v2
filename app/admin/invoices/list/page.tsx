...
export default function InvoiceListPage() {
  ...
  const handleDelete = async (invoiceNumber: string) => {
    ...
    try {
      ...
      const data = await response.json();      if (data.success) {
        addToast({ description: "Invoice deleted successfully", color: "success" });
        fetchInvoices(pagination.page);
      } else {
        addToast({ description: data.message || "Failed to delete invoice", color: "danger" });
      }
    } catch (error) {
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col justify-between mb-8">
          ...
          <div className="flex gap-2">
            <Button onClick={() => fetchInvoices(pagination.page)} variant="solid">
                ...
                <table className="w-full">
                  <thead className="bg-muted">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-sm font-medium">Linked ID</th>
                          ...
                          <div className="flex justify-end gap-2">
                            <Button
                              ...
                              title="View Invoice"                              onClick={() => {
                                ...
                                addToast({ description: "View functionality coming soon!", color: "default" });
                              }}
                            >
