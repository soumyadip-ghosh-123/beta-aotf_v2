...
export default function Page() {
  return (
    <div>
      ...
      <div className="md:py-15 bg-gradient-to-b from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 min-h-screen">
        <div className="container mx-auto px-4 md:px-8 pb-20">
          <div className="mx-auto prose prose-gray dark:prose-invert bg-white/80 dark:bg-gray-950/80 rounded-lg p-8 shadow-md">
            ...
            <p>
              ...
              disclose, and safeguard your information across our website,
              mobile applications, and any offline communication channels.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li>
                    Full name, phone number, email address, and physical
                    address.
                  </li>
                  <li>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                To send notifications, updates, reminders, and support
                responses.
              </li>
              <li>
            ...
            <p>
              By signing up or using our platform, you agree to our collection
            ...
            <p>
              We do <strong>not</strong> sell your personal data. Your
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                With trusted third-party services (e.g., hosting, email,
                storage) that operate under confidentiality and data protection
                agreements.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                SSL encryption for web traffic and sensitive transactions.
              </li>
              <li>
                Access controls, authentication workflows, and password hashing.
              </li>
              <li>
                Routine audits, security monitoring, and threat detection
                systems.
              </li>
            </ul>
            <p>
              Despite our best efforts, no system is completely immune to
              security risks. Use of our platform is at your own discretion and
              risk.
            </p>
