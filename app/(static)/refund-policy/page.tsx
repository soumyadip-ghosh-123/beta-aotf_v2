    ...
    <div>
      ...
      <div className="mx-auto max-w-7xl px-6 pb-5">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            The tuition is discontinued by the guardian within the first month;
            and
          </li>
          <li>
          ...
          <li>
            Proper documentation (such as written proof from the guardian) is
            submitted within <strong>7 days</strong> of discontinuation.
          </li>
        </ul>
        ...
        <p>
          ...
          <strong>50% of the first month&apos;s remuneration</strong> under both
          fee structures. Refunds will be issued via bank transfer within{" "}
          <strong>10 business days</strong> of approval.
        </p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            Failure to provide verifiable proof of discontinuation within the
            required timeline.
          </li>
          <li>
        ...
        <p>
          Refunds for Candidates/Job-seekers apply based on project milestones:
        </p>
        <ul className="list-disc pl-6 space-y-2">
          <li>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            ...
            Teacher/Freelancer, a <strong>service fee</strong> may be deducted.
          </li>
          <li>
        ...
        <p className="mt-4">
          Clients/Guardians must raise disputes only through official Academy
          channels.
        </p>
        ...
        {/* FINALITY */}
        <h2 className="text-2xl mt-6 mb-2 font-semibold">Decision Finality</h2>
        <p>
          The Academy&apos;s management holds the final decision-making
          authority on all refund, payment, and dispute matters. All
          parties—Teachers, Candidates/Job-seekers, and Clients—agree that the
          Academy&apos;s decision shall be final and binding.
        </p>
      </div>
    </div>
  );
