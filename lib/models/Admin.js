...
var adminSchema = new mongoose_1.Schema({
    ...
    permissions: { type: permissionsSchema, default: function () { return ({}); } },
...
var Admin = (_a = mongoose_1.default.models.Admin) !== null && _a !== void 0 ? _a : mongoose_1.default.model("Admin", adminSchema);
